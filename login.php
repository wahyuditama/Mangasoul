...
<html lang="en">
  ...
  <style>
    ...
    @media only creen and (max-width: 760px) {
      .box-area {
        margin: 0 10px;
      }
      .left-box {
  ...
  <body>
    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
      ...
      <div class="row border rounded-5 p-3 bg-white shadow box-area">
        <!-- sidebox left -->
        <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: blue">
          ...
          <div class="row align-items-center">
            ...
            <div class="input-group mb-5 d-flex justify-content-between">
              <div class="form-check">
                ...
                <label for="form-check" class="form-check text-secondary"><h2>Remember us</h2></label>
              </div>
              <div class="forgot">
            ...
            <div class="input-group mb-3">
              <button class="btn btn-lg btn-primary w-100 fs-6"><img src="" sty;e="width:20px;" class="me-2" />Up by Browser</button>
            </div>
            <div class="row">
